...
<html lang="fr-FR">
    ...
    <body>
        ...
        <section>
            ...
            <hr><p class="titresArticles">Article 1 - Informations légales</p>
            ...
            <p class="sousTitres"><b>A. Éditeur du site</b></p><!-- comment -->            
            ...
            <hr><p class="titresArticles">Article 2 - Confidentialité</p>
            <p><b>A. Données collectées et traitées</b></p>
            ...
            <p>Les données à caractère personnel collectées sur le site Nolark sont les suivantes :</p>
            <ul>
                <li>Nom</li>
                <li>Prénom</li>
            ...
            <p class="sousTitresN2">a. Droit d'accès, de rectification et droit à l'oubli</p>
            ...
            <p class="sousTitresN2">b. Droit à la portabilité des données</p>
            ...
            <p class="sousTitresN2">c. Droit à la limitation et à l'opposition du traitement des données</p>
            ...
            <p class="sousTitresN2">d. Droit de déterminer le sort des données après la mort</p>
            ...
            <p class="sousTitresN2">e. Droit de saisir l'autorité de contrôle compétente</p>
            ...
            <br>
            <p>En naviguant sur le site, il est porté à connaissance de l'utilisateur que des fichiers "cookies" de tiers peuvent être enregistrés. Il s'agit plus particulièrement des tiers suivants :</p>
            <table>
                <tbody>
                    <tr>
                        <th>Tier</th>
            ...
            <hr><p class="titresArticles">Article 3 - accessibilité</p>
            ...
            <hr><p class="titresArticles">Article 4 - loi applicable et juridiction</p>
            ...
            <hr><p class="titresArticles">Article 5 - contact</p>
